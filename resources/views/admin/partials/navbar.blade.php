<div class="h-12 bg-navy flex justify-between items-center px-4">
    <div class="flex items-center">
        <a href="/admin/dashboard" class="font-black text-orange no-underline no-font-space">
            <img src="/images/logos/cpa_logo_symbol.png" class="h-6"
                 alt="">
        </a>
    ...
    <div class="flex items-center justify-end text-orange">
        @if(auth()->user()->is_manager)
            ...
            <dropdown-menu v-cloak
                ...
                <div slot="dropdown_content"
                     class="pt-3">
                    <a href="/admin/manage-staff-leave"
                       class="text-grey-darker no-underline hover:text-orange-light pb-3 block">員工請假紀錄</a>
                    <a href="/admin/past-leave-requests-page"
                       class="text-grey-darker no-underline hover:text-orange-light">過去請假紀錄</a>
                </div>
            </dropdown-menu>
            ...
            <dropdown-menu v-cloak
                ...
                <div slot="dropdown_content"
                    ...
                    <a href="/admin/manage-reports/staff-cost"
                       class="text-grey-darker no-underline hover:text-orange-light pb-3 block">每月員工成本</a>
                    <a href="/admin/manage-reports/client-cost"
                       class="text-grey-darker no-underline hover:text-orange-light pb-3 block">每月客戶成本</a>
                </div>
            </dropdown-menu>
            <dropdown-menu v-cloak
                           name="客戶"
